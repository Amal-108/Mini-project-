            ...
            <div class="cards-container">
                <div class="card card-one" id="add-student-card">
                    <div class="card-content">
                        <h3 class="card-title">Add Location and Assign Activities</h3>
                        <p class="card-para">Add location and assign activities for batches</p>
                    </div>
                </div>

                <div class="card card-two">
                    <div class="card-content">
                        <h3 class="card-title">Modify Location</h3>
                        <p class="card-para">View and modify locations.</p>
                    </div>
                </div>

                <div class="card card-one">
                    <div class="card-content">
                        <h3 class="card-title">Delete Location</h3>
                        <p class="card-para">Remove locations.</p>
                    </div>
                </div>
                <div class="card card-four">
                    <div class="card-content">
                        <h3 class="card-title">View Assigned Locations</h3>
                        <p class="card-para">.</p>
                    </div>
